...
#      }
	...
	my @list  = (  "fates_spitfire_mode", "use_fates_planthydro", "use_fates_ed_st3", "use_fates_ed_prescribed_phys",
		       "use_fates_cohort_age_tracking", 
                      "use_fates_inventory_init","use_fates_fixed_biogeog","use_fates_nocomp","use_fates_bigleaf","fates_inventory_ctrl_filename","use_fates_logging","fates_parteh_mode" );
       foreach my $var ( @list ) {
          if ( defined($nl->get_value($var)) ) {
...
sub setup_logic_fates {
    ...
    if (&value_is_true( $nl_flags->{'use_fates'})  ) {
        ...
        my @list  = (  "fates_spitfire_mode", "use_fates_planthydro", "use_fates_ed_st3", "use_fates_ed_prescribed_phys", 
                       "use_fates_inventory_init","use_fates_fixed_biogeog","use_fates_nocomp","use_fates_bigeaf","use_fates_logging","fates_parteh_mode", "use_fates_cohort_age_tracking" );
        foreach my $var ( @list ) {
